...
export type DebateStage = Tables<"debate_stages">;
export type DebateStageInsert = TablesInsert<"debate_stages">;
export type DebateStageUpdate = TablesUpdate<"debate_stages">;

export type VerificationChallenge = Tables<"verification_challenges">;
export type VerificationChallengeInsert =
  TablesInsert<"verification_challenges">;
export type VerificationChallengeUpdate =
  TablesUpdate<"verification_challenges">;
